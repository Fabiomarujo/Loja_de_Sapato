...
def gerar_data_aleatoria(tipo_data):
    ...
    if tipo_data == 'inicial':
        ...
        ano = gerar_numero_aleatorio_faixa(2021,2025)
...
def truncar_tabelas():
    truncate_table('clientes_clientes')
    truncate_table('contato_contato')
    truncate_table('fornecedor_fornecedor')
    truncate_table('produto_produto')
    truncate_table('venda_venda')
